...
function ProfileInfo({
  ...
  const { username, visible, age, gender, sendEmails, privacyAgreed } =
    userFields;
  const [languages, setLanguages] = useState<UserAccentLocales>([]);
  ...
  useEffect(() => {
    ...
    setLanguages(account ? account.locales : userAccentLocales);
  }, [user]);
  ...
  const submit = useCallback(() => {
    ...
    const data = {
      ...
      locales: languages.filter(l => l.locale),
  ...
  }, [api, getString, locale, languages, termsStatus, user, userFields]);
  ...
  return (
    <div className="profile-info">
      ...
      <ProfileInfoLanguages languages={languages} setLanguages={setLanguages} />
